...
WHERE REGEXP_MATCHES(a_clm01,   'TUBER|CONSUMP|PHTH')
...
all$gen_birthplace_icpsr1 <- bplace$gen_birthplace_icpsr1
all$gen_birthplace_icpsr2 <- bplace$gen_birthplace_icpsr2
all$gen_rb_cnty_icpsr1 <- bplace$gen_rb_cnty_icpsr1
all$gen_rb_cnty_icpsr2 <- bplace$gen_rb_cnty_icpsr2
...
write_csv(tb, "../data/in-progress/tb_v7.csv")
write_csv(ntb, "../data/in-progress/ntb_v6.csv")
