...
mil = fread("Raw Data/mil_union_army.csv")
dis = fread('Raw Data/dis_union_army.csv')
msr = fread('Raw Data/msr_union_army.csv')
cen = fread("Raw Data/cen_union_army.csv")
...
first_tb_full <- all_birth |>
  left_join(first_tb_full, by = "recidnum") |>
  mutate(
